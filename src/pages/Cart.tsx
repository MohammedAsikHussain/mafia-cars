  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
        <button onClick={() => navigate(-1)} className="absolute top-24 left-4 inline-flex items-center text-black hover:text-secondary font-medium transition-colors md:left-10">
        ...
        <Link to="/shop" className="px-8 py-3 bg-primary text-white rounded-lg font-semibold hover:bg-gray-800 transition-colors">Start Shopping</Link>
      </div>
    );
  }
