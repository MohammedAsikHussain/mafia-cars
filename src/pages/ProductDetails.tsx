            ...
            {checkoutStep === 'payment' && (
              <div className="p-6">
                 <div className="space-y-4 mb-4">
                    ...
                    <label className={`flex items-center p-4 border rounded-xl cursor-pointer ${selectedPayment === 'cod' ? 'border-secondary bg-yellow-50' : ''}`} onClick={() => setSelectedPayment('cod')}>
